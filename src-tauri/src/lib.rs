...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::entities::load_custom_entities,
            commands::entities::save_custom_entity,
            commands::entities::remove_custom_entity,
            commands::entities::clear_custom_entities,
            commands::entities::validate_entity_name,
            ...
            commands::metadata::generate_tei_header,
            commands::metadata::generate_tei_footer,
            commands::metadata::validate_metadata,
            commands::metadata::create_empty_metadata,
        ])
